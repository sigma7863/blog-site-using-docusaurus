...
translation=指定の場所に保管庫を作成できませんでした。もう一度場所とパーミッションを確認してください。

[interface.start-screen.msg-error-failed-to-open-vault]
original=Failed to open.
translation=開くことができませんでした。
...
translation=このリモート保管庫の削除を行いますか？
